// Generated by SolidPython 1.1.3 on 2024-05-16 22:57:10
...
difference() {
	difference() {
		...
		translate(v = [15.1373000000, 14.4444000000, 0.8]) {
			linear_extrude(height = 0.3333333333333333) {
				text(halign = "center", size = 0.5000000000, text = "2");
			}
		}
	}
	translate(v = [15.6686218750, 14.3780750000, 0.8]) {
		linear_extrude(height = 0.3333333333333333) {
