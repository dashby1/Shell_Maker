// Generated by SolidPython 1.1.3 on 2024-05-16 22:42:14
...
difference() {
	difference() {
		...
		translate(v = [-16.0392000000, 16.7322000000, 0.8]) {
			linear_extrude(height = 0.3333333333333333) {
				text(halign = "center", size = 0.5000000000, text = "1");
			}
		}
	}
	translate(v = [-15.4623000000, 16.7329000000, 0.8]) {
		linear_extrude(height = 0.3333333333333333) {
