// Generated by SolidPython 1.1.3 on 2024-05-16 23:01:58
...
difference() {
	difference() {
		...
		translate(v = [-13.4193000000, -14.1122000000, 0.8]) {
			linear_extrude(height = 0.3333333333333333) {
				text(halign = "center", size = 0.5000000000, text = "2");
			}
		}
	}
	translate(v = [-12.8844812500, -14.2109218750, 0.8]) {
		linear_extrude(height = 0.3333333333333333) {
			text(halign = "center", size = 0.5000000000, text = "9");
		}
	}
}
/***********************************************
