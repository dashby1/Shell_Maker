// Generated by SolidPython 1.1.3 on 2024-05-16 22:51:10
...
difference() {
	difference() {
		...
		translate(v = [-15.0238000000, 15.7168000000, 0.8]) {
			linear_extrude(height = 0.3333333333333333) {
				text(halign = "center", size = 0.5000000000, text = "1");
			}
		}
	}
	translate(v = [-14.5049000000, 15.7447750000, 0.8]) {
		linear_extrude(height = 0.3333333333333333) {
			text(halign = "center", size = 0.5000000000, text = "8");
		}
	}
}
/***********************************************
